class CompUiValidation {
    initialise() {
        this.formValidationSelector = 'form.compui-validation';
        ...
        if ($(this.formValidationSelector).length > 0) {
            this.InitialiseFieldValidationClassSwaps();
            this.InitialiseDateFieldValidation();
        }
    }

    InitialiseFieldValidationClassSwaps(thisClass) {
        ...
        var formValidationSelectors = this.formValidationSelector + ' .' + this.fieldErrorClassName + ', ' + this.formValidationSelector + ' .' + this.fieldValidClassName;
        var thisClass = this;
